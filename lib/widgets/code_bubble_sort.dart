...
class CodeBubbleSort extends StatefulWidget {
  @override
  _CodeBubbleSortState createState() => _CodeBubbleSortState();
}

class _CodeBubbleSortState extends State<CodeBubbleSort> {
